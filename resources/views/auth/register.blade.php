        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            <div class="text-center">
              <h1 class="text-4xl font-semibold text-white">{{ __('auth.signup') }}</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            ...
            >
              ...
              <p class="mb-6 text-base text-[#adadad]">{{ __('auth.connect_with') }}</p>
