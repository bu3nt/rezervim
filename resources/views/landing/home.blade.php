              ...
              >
                ...
                <div class="text-center">
                  <div class="relative z-10 inline-block">
                    <img
                      src="{{ asset('assets/images/about/about-image.svg') }}"
                      alt="image"
        ...
        <div class="flex flex-wrap items-center justify-center">
          <div class="w-full md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <h2 class="mb-9 text-[28px] font-semibold text-primary">
                {{ __('plan.currency', ['value' => $plans[0]->monthly]) }}/mo
              </h2>
          ...
          <div class="w-full md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <h2 class="mb-9 text-[28px] font-semibold text-white">
                {{ __('plan.currency', ['value' => $plans[1]->monthly]) }}/mo
              </h2>
          ...
          <div class="w-full md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <h2 class="mb-9 text-[28px] font-semibold text-primary">
                {{ __('plan.currency', ['value' => $plans[2]->monthly]) }}/mo
              </h2>
          ...
          <div class="w-full px-4 lg:w-1/2">
              ...
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Si mund të kryej një rezervim online përmes aplikacionit tuaj?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Për të kryer një rezervim, hapni aplikacionin tonë dhe zgjidhni opsionin e rezervimit. Pas zgjedhjes së datës dhe kohës së dëshiruar, ndiqni udhëzimet për të plotësuar informacionin e nevojshëm dhe konfirmojeni rezervimin tuaj
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    A mund të modifikoj ose anuloj rezervimin tim të cilin e kam vendosur paraprakisht?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Po, mund të modifikoni ose anuloni rezervimin tuaj përmes aplikacionit tonë. Ju lutemi të konsultoheni me seksionin e "Rezervimeve të mia" për opsionet e ndryshimit apo anulimit.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Cilat janë metodat apo menyrat e pagesave për rezervimet online?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Ne pranojmë një gamë të gjerë të kartave të kreditit dhe metodave të tjera të pagesës. Informacioni i detajuar për metodat e pagesës mund të gjendet në faqen tonë të "Pagesës dhe Faturimit".
                </p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 lg:w-1/2">
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    A ka një aplikacion për burimet mobile, siç janë Android dhe iOS?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Po, ofrojmë një aplikacion të dedikuar për platformat mobile si Android dhe iOS. Mund ta shkarkoni nga dyqanet e aplikacioneve të përshtatshme..
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    A mund të marr konfirmimin e rezervimit nëpërmjet SMS ose email-it?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Po, pasi të kryeni një rezervim, do të merrni një konfirmim automatik përmes SMS-it ose email-it, në varësi të preferencave të konfirmuara në profilin tuaj..
                </p>
              </div>
            </div>
            <div
            ...
            >
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Cilat janë masat e sigurisë për mbrojtjen e të dhënave personale?
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Ne kemi implementuar masat më të larta të sigurisë për mbrojtjen e të dhënave tuaja personale. Për detaje të mëtejshme, ju lutemi të lexoni politikën tonë të privatësisë në faqen kryesore të aplikacionit..
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  ...
                  <p class="text-xs text-[#969696]">{{ $testimonial->position }}</p>
                </div>
              </div>
            </div>
          </div>          
          ...
          <!-- <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="{{ asset('assets/images/testimonials/author-01.png') }}"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="{{ asset('assets/images/testimonials/author-02.png') }}"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                >
                  <img
                    src="{{ asset('assets/images/testimonials/author-03.png') }}"
                    alt="author"
                  />
                </div>
                <div class="ud-testimonial-meta">
            ...
            <div class="wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="ud-brands-logo flex flex-wrap items-center">
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/brands/tailgrids.svg') }}"
                      alt="tailgrids"
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/brands/ayroui.svg') }}"
                      alt="ayroui"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/brands/uideck.svg') }}"
                      alt="uideck"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/brands/graygrids.svg') }}"
                      alt="graygrids"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="{{ asset('assets/images/brands/lineicons.svg') }}"
                      alt="lineicons"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
              ...
              >
                <img
                  src="{{ asset('assets/images/team/team-01.png') }}"
                  alt="image"
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              >
                <img
                  src="{{ asset('assets/images/team/team-02.png') }}"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".2s">
              ...
              >
                <img
                  src="{{ asset('assets/images/team/team-03.png') }}"
                  alt="image"
                  class="w-full rounded-full"
                />
                <span class="absolute top-0 left-0 z-[-1]">
            ...
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                <h2 class="text-[35px] font-semibold">
                  Hajde të bisedojmë <br />
                  Do të donim të dëgjojmë nga ju!
                </h2>
              </div>
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h5 class="mb-6 text-lg font-semibold">Vendndodhja</h5>
                    <p class="text-base text-body-color">
                      Ferid Domi, nr.12, Gjakovë, Kosovë
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h5 class="mb-6 text-lg font-semibold">Si mund të ju ndihmojmë?</h5>
                    <p class="text-base text-body-color">info@rezervim.online</p>
                    <p class="text-base text-body-color">
                      contact@rezervim.online
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="w-full px-4 lg:w-5/12 xl:w-4/12">
            ...
            >
              <h3 class="mb-8 text-2xl font-semibold md:text-[26px]">
                {{ __('landing.contact_form.send_message_title') }}
              </h3>
              <form method="POST" action="{{ route('landing.contact_us') }}">
                @csrf
                <div class="mb-6">
                  <label for="fullName" class="block text-xs text-dark"
                    >{{ __('landing.contact_form.full_name') }}*</label
                  >
                  <input
                    type="text"
                    name="fullName"
                ...
                <div class="mb-6">
                  <label for="email" class="block text-xs text-dark"
                    >{{ __('landing.contact_form.email') }}*</label
                  >
                  <input
                    type="email"
                    name="email"
                ...
                <div class="mb-6">
                  <label for="phone" class="block text-xs text-dark"
                    >{{ __('landing.contact_form.phone') }}*</label
                  >
                  <input
                    type="text"
                    name="phone"
                ...
                <div class="mb-6">
                  <label for="message" class="block text-xs text-dark"
                    >{{ __('landing.contact_form.message') }}*</label
                  >
                  <textarea
                    name="message"
                    rows="1"
