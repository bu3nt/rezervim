<x-admin-layout>
    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-6">
                <h3>{{ __('navigation.admin.dashboard') }}</h3>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('navigation.admin.dashboard') }}</li>
                </ol>
            </div>
        </div>        
    </x-slot>
    ...
    <div class="row widget-grid">
        ...
        <div class="card profile-box">
            ...
            <div class="media media-wrapper justify-content-between">
                ...
                <div class="greeting-user">
                    <h4 class="f-w-600">{{ config('app.name') }}</h4>
        ...
        <div class="card purchase-card"><img class="img-fluid" src="{{ asset('assets/images/dashboard/purchase.png') }}" alt="vector mens with leptop">
            ...
            <h6 class="mb-3">Buy <a href="#">Pro Account </a>to Explore Primium Features</h6><a class="purchase-btn btn btn-primary btn-hover-effect f-w-500" href="#" target="_blank">Purchase Now</a>
            </div>
        </div>
        </div>
