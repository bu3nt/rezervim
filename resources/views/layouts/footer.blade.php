      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="mb-7 text-base text-[#f3f4fe]">
                Rezervo me lehtësi, jeto me rahatësi. Fito orën tende me aplikacionin tonë të rezervimeve online!
              </p>
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">Rreth Nesh</h4>
              <ul>
                <li>
                  <a
                    href="#home"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">Karakteristikat</h4>
              <ul>
                <li>
                  <a
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">Bashkëpunimet</h4>
